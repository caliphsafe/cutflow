...
const plans = [
  { code: "starter", name: "Starter", price: 39, features: ["1 barber", "Branded booking page", "Deposits + client profiles", "Monthly reports"] },
  { code: "pro", name: "Pro", price: 69, featured: true, features: ["1 barber", "Smart repeat requests", "Advanced reports", "Notification workflow", "Priority support"] },
  { code: "studio", name: "Studio", price: 119, features: ["Up to 5 barbers", "Shared shop inventory", "Team permissions", "Shop-wide reporting"] },
];
...
export default function SubscriptionPage() {
  ...
  const currentPlan = plans.find((plan) => plan.code === subscription?.planCode) || plans[1];
